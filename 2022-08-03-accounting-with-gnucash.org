...
#+subtitle: Things to remember when using GnuCash for Accounting
#+description: Notes on accounting and GnuCash
#+date: 2022-09-03
#+keywords: Accounting, GnuCash
#+html_link_home: ./
#+html_link_up: ./
...
#+end_src
#+ATTR_HTML: :width 100%;
[[file:./img/AccountingEquation.png]]
